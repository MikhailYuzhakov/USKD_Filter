...
title = 'Air temperature'  # Атмосферное давление Температура окружающего воздуха Относительная влажность воздуха Температура окружающего воздуха
label_x = 'Date, dd.mm.yy'
label_y = 'Temperature, ℃'  # Температура, ℃ Давление, мм.рт.ст. Влажность, %ОВ
legend_pos = 'lower right'  #
legend_1 = 'Probe №7'
legend_2 = 'Temperature log'
filename_png = 'temp_bmp(7)_vs_garden'  # temp_bmp(14)_vs_RP5 press_bmp(14)_vs_RP5
filename_csv = 'probe7.csv'
filename_xlsx = 'garden.xlsx'
sensor_name = 'temp_bmp'  # temp_bmp press_bmp
rp5_sensor_name = 'Суккуленты_2'  # P U T
up_limit = 40
down_limit = 0
up_x_axis_limit = 19097  # кол-во дней с 01.01.1970
down_x_axis_limit = 18887
up_y_axis_limit = 20
down_y_axis_limit = 5
gauss_sigma = 2
...
for i in range(weather_RP5.shape[0]):
    ...
    time_rp5[i] = datetime.datetime.strptime(str(weather_RP5['Datetime'][i]), "%Y-%m-%d %H:%M:%S")  # записываем дату
j = 0
