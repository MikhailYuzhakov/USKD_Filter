...
title = 'Относительная влажность воздуха'  # Атмосферное давление Температура окружающего воздуха
label_x = 'Дата, дд.мм.гг'
label_y = 'Влажность, %ОВ'  # Температура, ℃ Давление, мм.рт.ст.
legend_pos = 'lower right'  #
legend_1 = 'Агрозонд №14'
legend_2 = 'Сервис RP5'
filename_png = 'hum_htu(14)_vs_RP5'  # temp_bmp(14)_vs_RP5 press_bmp(14)_vs_RP5
filename_csv = 'probe14_new.csv'
filename_xlsx = 'RP5.xlsx'
sensor_name = 'hum_htu'  # temp_bmp press_bmp
rp5_sensor_name = 'U'  # P
up_limit = 100
down_limit = 0
up_x_axis_limit = 18969  # кол-во дней с 01.01.1970
down_x_axis_limit = 18897
up_y_axis_limit = 100
down_y_axis_limit = 40
gauss_sigma = 4
...
myFmt = matplotlib.dates.DateFormatter('%d.%m.%y')
plt.gca().xaxis.set_major_formatter(myFmt)
plt.tick_params(labelrotation=0.0)
